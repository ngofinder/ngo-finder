...
STATICFILES_DIRS = (
    os.path.join(SITE_ROOT,'directory/static'),
...
SECRET_KEY = '-(3*nd#&amp;wmpfdaaozv4zgbu$l_j_!vei%sv=q&amp;fwel^*l(e97s'
...
ROOT_URLCONF = 'ngo_finder.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ngo_finder.wsgi.application'
...
HAYSTACK_SITECONF = 'ngo_finder.search_sites'
